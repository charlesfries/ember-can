...
export default class AbilitiesService extends Service {
     ...
     */
    abilityFor(abilityName: string, model?: Record<string, unknown>, properties?: Record<string, unknown>): Ability;
    /**
     ...
     */
    valueFor(propertyName: string, abilityName: string, model?: Record<string, unknown>, properties?: Record<string, unknown>): unknown;
    /**
     ...
     */
    can(abilityString: string, model?: Record<string, unknown>, properties?: Record<string, unknown>): boolean;
    /**
     ...
     * @return {Boolean}              value of ability converted to boolean
     */
    cannot(abilityString: string, model?: Record<string, unknown>, properties?: Record<string, unknown>): boolean;
}
